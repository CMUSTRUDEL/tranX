...
from create_tree2tree_data import ProcessedAST, T2TDataProcessor
...
class Args(Arguments):
    ...
    test_data_file: str = "../Tree2Tree/tree2tree_data/test/data.pkl"
    eval_file: str
    pdb: Switch = False
...
def main():
    ...
    processor = T2TDataProcessor(args.asdl_path, args.spm_model_path, strict=False)
    ...
    print(f"BLEU4: {corpus_bleu(references, hypothesis)}")
